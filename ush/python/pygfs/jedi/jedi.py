...
class Jedi:
    ...
    def render_jcb(self, task_config: AttrDict, algorithm_in: Optional[str] = None) -> AttrDict:
        ...
        if self.jedi_config.jcb_base_yaml is not None:
            ...
            raise WorkflowKeyError(f"JCB base YAML not specified as key 'jcb_base_yaml' in JEDI-class config dictionary")
        ...
        if algorithm_in is not None:
            ...
            raise WorkflowKeyError(f"JCB algorithm not specified")
